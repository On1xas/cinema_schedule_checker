...
def insert_data_tms_arena_sql(data_parsing_arena,cur,conn,date=str(datetime.date.today())):
    for show in data_parsing_arena:
        if date in show[1]:
            if show[0]=='R1 S':
                cur.execute("INSERT INTO ARENA_1_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("Silver Screen в ТРЦ Arena city", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R2 S 3D DA':
                cur.execute("INSERT INTO ARENA_2_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("Silver Screen в ТРЦ Arena city", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R3 S':
                cur.execute("INSERT INTO ARENA_3_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("Silver Screen в ТРЦ Arena city", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R4 S 3D DA':
                cur.execute("INSERT INTO ARENA_4_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("Silver Screen в ТРЦ Arena city", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R5 S':
                cur.execute("INSERT INTO ARENA_5_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("Silver Screen в ТРЦ Arena city", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R6 S 3D':
    ...
    for show in data_parsing_dana:
        if date in show[1]:
            if show[0]=='R1 S 3D DA':
                cur.execute("INSERT INTO DANA_1_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("mooon в ТРЦ Dana Mall", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R2 F':
                cur.execute("INSERT INTO DANA_2_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("mooon в ТРЦ Dana Mall", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R3 S SX':
                cur.execute("INSERT INTO DANA_3_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("mooon в ТРЦ Dana Mall", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R4 S':
                cur.execute("INSERT INTO DANA_4_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("mooon в ТРЦ Dana Mall", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R5 S 3D':
                cur.execute("INSERT INTO DANA_5_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("mooon в ТРЦ Dana Mall", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R6 S':
                cur.execute("INSERT INTO DANA_6_ROOM_TMS (TH_NAME, ROOM, SHOW_START, SPL_TITLE, CPL_TITLE) VALUES (?, ?, ?, ?, ?)",("mooon в ТРЦ Dana Mall", show[0], show[1], show[2], show[3]))
                conn.commit()
            elif show[0]=='R7 S':
